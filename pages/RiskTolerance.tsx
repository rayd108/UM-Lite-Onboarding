  ...
  return (
    <div className="flex flex-col h-screen bg-white dark:bg-gray-900 font-display relative p-8">
      ...
      <main className="flex-grow mt-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight">Risk tolerance</h1>
        <p className="mt-4 text-gray-500 dark:text-gray-400 text-base leading-relaxed">
          The global stock market is often a volatile place. If your entire investment portfolio lost 10% of its value in a month during a market decline, what would you do?
        </p>

        <div className="mt-10">
          <label className="block text-sm font-bold text-gray-900 dark:text-gray-100 mb-3" htmlFor="risk">
          ...
          <div className="relative">
            ...
            >
              <option value="">What would you do?</option>
              <option value="sell-all">Sell all of your investments</option>
      ...
      <footer className="mt-auto pb-4">
        <button 
          onClick={() => selection && navigate('/investment-knowledge')}
          disabled={!selection}
