...
const WithdrawalTimeframe: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-white dark:bg-gray-900 font-display relative p-8">
      ...
      <main className="flex-grow mt-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight">Estimate when you'll need to withdraw</h1>
        <p className="mt-4 text-gray-500 dark:text-gray-400 text-base leading-relaxed">
          When might you need to withdraw 20% of your current portfolio value?
        </p>

        <div className="mt-10">
          <label className="block text-sm font-bold text-gray-900 dark:text-gray-100 mb-3" htmlFor="timeframe">
          ...
          <div className="relative">
            ...
            >
              <option value="">Select withdrawal timeframe</option>
              <option value="under2">2 years or less</option>
              <option value="2-5">2-5 years</option>
              <option value="5-10">5-10 years</option>
              <option value="10-15">10-15 years</option>
              <option value="15plus">More than 15 years</option>
            </select>
          </div>
        </div>
      </main>
      ...
      <footer className="mt-auto pb-4">
        <button 
          onClick={() => selection && navigate('/net-worth')}
          disabled={!selection}
...
export default WithdrawalTimeframe;
